...
if (isset($_POST['submit'])) {
    ...
    if ($_POST['password'] == '') {
       ...
       if (empty($error_message)) { 
        $sql = "INSERT INTO `userresgistation`(`username`,`Phone`,`address`,`email`,`password`) 
 VALUES('" . $_POST['username'] . "','" . $_POST['Phone'] . "','" . $_POST['address'] . "','" . $_POST['email'] . "','" .md5( $_POST['password'] ). "')";
    ...
    <li class="dropdown-submenu"> <a tabindex="-1" href="#">More options</a>
        ...
        <ul class="dropdown-menu">
    		...
    		<div class="panel panel-default">
			  	<div class="panel-heading">
			    	<h3 class="panel-title"> Registation for user</h3>
                             <?php
        if (!empty($error_message)) {
            echo $error_message;
        }
        ?>
			  	...
			  	<div class="panel-body">
			    	...
			    	<form accept-charset="UTF-8" role="form" method="post" action="userresgistation.php">
                    <fieldset>
