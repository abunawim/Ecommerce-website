				            ...
				            <div class="col-lg-12" id="menua">
                                    ...
                                    <div class="navbar navbar-static" >
                                        <div class="navbar-inner" style="background-color:#009933">
                                                              ...
                                                              <from action="s.php" enctype="multipart/form-data" method="post">
                                                                  <input  type="text" placeholder="Search" name="product_name" value=""> 
		...
		<div id="sidebar">
		     <div class="container"> 
			       <div class="row">
                    ...
                    <!---------------------------------------End for product----------------------------------------------------->
                                                      <h2 style="text-align:center;"> All Product of Pant </h2>
                    
                    <?php
					
					
						$sql = "SELECT * FROM `program_project` where category_id=24";
				...
				//
					...
					//////////////////
                         ...
                         $sql= "select * from `program_project` where category_id=24 limit $start , $per_page ";
