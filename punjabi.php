		...
		<div id="sidebar">
		     <div class="container"> 
			       <div class="row">
                    ...
                    <!---------------------------------------End for product----------------------------------------------------->
                                                   <h2 style="text-align:center;"> All Product of Punjabi </h2>
                    
                    <?php
					
					
						$sql = "SELECT * FROM `program_project` where category_id=25";
				...
				//
					...
					//////////////////
                         ...
                         $sql= "select * from `program_project` where category_id=25 limit $start , $per_page ";
