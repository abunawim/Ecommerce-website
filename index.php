...
<link rel="stylesheet" type="text/css"  href="css/nivo-slider.css"/>
    ...
    <body >
		...
		<div id="sidebar">
		     <div class="container"> 
			       <div class="row">
				    ...
				    <!--------------------------------------------- Start for  slider----------------------------------------------------->
				         <div class="col-lg-9"  style="max-width:780px; margin-top:0px;" >
                    ...
                    <?php
						...
						$sql = "SELECT * FROM  `program_project` ";
				...
				//
					...
					//////////////////
                         ...
                         $sql= "select * from `program_project` limit $start , $per_page ";
		 ...
		 <div style="margin-left:170px;" >
                <div>
                        <div class="mainproduct" style="width:190px; height:300px; background-color:#FFF; margin-left:10px; margin-top:10px; float:left; border-radius:5px;">
			...
			echo ' Price '.$currency.$row->price.' </br> </br>';
            echo 'Qty <input type="text" name="product_qty" value="1" size="3" style="width:30px; height:15px; "/>';
			echo '<button class="add_to_cart " style="margin-top:-10px;">Add To Cart</button>';
			echo '</div></div>';
      ...
      <div  class="pagination" style="padding:5px; margin-top:630px; text-align:center;"> <!-- this div for pagination menu -->
...
if(isset($_SESSION["products"]))
{
	...
	echo ' </br><span class="empty-cart"><a href="cart_update.php?emptycart=1&return_url='.$current_url.'">Empty Cart </a></span>';
}else{
