		...
		<div id="sidebar">
		     <div class="container"> 
			       <div class="row">
                    ...
                    <!---------------------------------------End for product----------------------------------------------------->
                                                            <h2 style="text-align:center;"> All Product of shirt </h2>
                    
                    <?php
					
					
						$sql = "SELECT * FROM `program_project` where category_id=23";
				...
				//
					...
					//////////////////
                         ...
                         $sql= "select * from `program_project` where category_id=23 limit $start , $per_page ";
